...
* **Cianuro**: el cianuro no favorece al rendimiento, sino que el deportista, luego de consumirlo queda como muerto, llenos de abulia y de marasmo. Con cianuro, el rendimiento será 0 (cero) si el peso del deportista es 70 o menos. Si es mas que 70, 1% del peso + la dosis.
